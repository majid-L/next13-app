...
function BingMapsReact(_ref) {
      ...
      Maps.Events.addHandler(newPin, "mouseover", e => {
        ...
        infobox.setOptions(_objectSpread({
          ...
          actions: [{
            ...
            eventHandler: () => router.push(`/candidates/${e.target.metadata.candidateId}`)
          }]
        }, pushPin.infobox));
      });
  ...
  }, [addPushpinsWithInfoboxes, addPushpins, bingMapsKey, mapOptions, onMapReady, pushPins, pushPinsWithInfoboxes, viewOptions]);
  (0, _react.useEffect)(() => {
