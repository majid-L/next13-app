...
{isLoading ? <Spinner/> : <div className="bg-white border-1 border-gray-700 shadow-lg shadow-pink-300/40 overflow-hidden rounded-lg w-11/12 mb-10 max-w-3xl m-auto">
<div className="p-6 pb-4 text-gray-900 text-left">
    <p className="font-bold text-lg">{(exam as Exam).candidateName} <span className="font-medium">(ID: {exam.candidateId})</span></p>
...
<ExamForm formType="PUT" handleSubmit={handleSubmit} examDetails={examDetails as ExamFormFields} setExamDetails={setExamDetails}/>
