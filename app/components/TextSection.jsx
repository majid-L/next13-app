const TextSection = ({view}) => {
  ...
  return (<section>
    ...
    <p className="text-stone-100 --max-w-720 mx-auto mt-10 mb-4 md:text-xl">To see all exams for a specific student, click on an exam and you will be taken to the relevant page.<br/><br/>{view === 'map' && 'When using the map, you can zoom in/out and select different view styles.To view information on a specific exam, hover over its icon and from there you can either go to the exam page, or view more exams for that candidate.'}</p>
