...
return (<main>
    <svg style={{display: 'block', margin: '50px auto 0', height: '150px', width: '150px', color: '#FECACA'}} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-exclamation-square-fill" viewBox="0 0 16 16">
