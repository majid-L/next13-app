...
const SingleCandidateExams = ({
  ...
  return (
    <main className="pb-20 mx-auto w-11/12 sm:w-5/6">
      <h1 className="text-center text-stone-100 font-bold text-4xl md:text-5xl mt-12 mx-4 text-shadow-sm">
        {userIsAdmin(loggedInUser)
          ? `Viewing exam sessions for ${
              !isLoading && exams ? candidateName?.replaceAll("+", " ") : "..."
            }`
          : "My exams"}
      </h1>
      <p className="text-center text-stone-100 mt-4 mb-16 md:text-xl">
        {userIsAdmin(loggedInUser)
          ? "To see all exams for a specific student, click on an exam and you will be taken to the relevant page."
          : "For further details, click on an exam and you will be taken to its information page."}
      </p>
