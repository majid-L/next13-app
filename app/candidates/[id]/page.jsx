...
const {exams, isLoading} = useFetchExams(30, params.id);

return (
<main className="text-center mt-20 pb-20 mx-auto w-11/12 sm:w-5/6">
  <h1 className="text-center text-stone-100 font-bold text-4xl md:text-5xl mt-20">Viewing exam sessions for {exams[0]?.candidateName}</h1>
