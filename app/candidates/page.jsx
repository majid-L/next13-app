...
return (<main className="text-center pb-20 mx-auto w-11/12 sm:w-5/6">
  ...
  <p className="text-center text-stone-100 mt-4 mb-16 mx-auto w-4/5 md:text-xl">To see all current exams for a specific candidate, click on the link in the candidate's information section.</p>
